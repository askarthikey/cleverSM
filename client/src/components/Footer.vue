<template>
  <footer class="relative z-10 bg-black/20 backdrop-blur-lg border-t border-white/10">
      ...
      <div class="grid md:grid-cols-4 gap-8">
        <div class="col-span-1">
          ...
          <p class="text-white/60 text-sm">
            Connect, share, and inspire with the world's most creative community.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="#" class="text-white/60 hover:text-white transition-colors text-sm">Features</a></li>
            <li><a href="#" class="text-white/60 hover:text-white transition-colors text-sm">Pricing</a></li>
            <li><a href="#" class="text-white/60 hover:text-white transition-colors text-sm">Mobile App</a></li>
            <li><a href="#" class="text-white/60 hover:text-white transition-colors text-sm">Desktop</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-white/60 hover:text-white transition-colors text-sm">Privacy</a></li>
            <li><a href="#" class="text-white/60 hover:text-white transition-colors text-sm">Terms</a></li>
          </ul>
        </div>
      </div>
